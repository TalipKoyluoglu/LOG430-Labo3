...
class UC6_ValidationControleur:
    ...
    def valider_demande(self, demande_id):
        try:
            ...
            print(f"🔍 Demande trouvée : {demande.produit.nom} x{demande.quantite} pour {demande.magasin.nom}")
            ...
            if quantite <= 0 or stock_central.quantite < quantite:
                print("⚠️ Quantité insuffisante dans le stock central")
            ...
            print(f"✅ StockLocal {'créé' if created else 'existant'} avec {stock_local.quantite} unités")
